...
{
    cout<<"\n"<<"*****MENU*****\n";
   cout<<"INSTRUCCIONES: Utilizar solo numeros del 1 al 10 y letras MAYUSCULAS"; system("Color 0A");
    "\n";
    ...
    cout<<"\n"<<" A = 10:------> Crear de forma grafica la multiplicacion manual"; 
    cout<<"\n"<<" B = 11:------> Conversion numero decimal a binario";
    cout<<"\n"<<" C = 12:------> Conversion de numeros decimales a hexadecimales";
    cout<<"\n"<<" D = 13:------> Crear Figuras Geometricas Basicas";
    cout<<"\n"<<" E = 14:------> Mover un punto en toda la pantalla";
    cout<<"\n"<<" F = 15:------> Simulacion de un Cajero (Automata)";
    cout<<"\n"<<" G = 16:------> Muestre la hipotenusa";
    cout<<"\n"<<" H = 17:------> Calculadora Basica";
    cout<<"\n"<<" I = 18:------> Rango entre 10 y 20";
    cout<<"\n"<<" J = 19:------> Vocal o Consonante";
    cout<<"\n"<<" K = 20:------> Promedio de las notas";
...

    {
        ...
        int i,numeros;
   			cout<<"\n"<<  "Ingrese una palabra: ";
   		cin >> palabra;
   			cout<<"\n"<<"Ingrese un numero para saber si este es palindromo o no lo es: ";
   			cin>>numeros;
 ...
 case '6': cout<<"\n"<< "Usted ha seleccionado la opcion 6 v";
        {
...
int x;
  ...
  case '7': cout<<"\n"<< "Usted ha seleccionado la opcion 7 v";
  {
...
if(n1>=10 and n1<=20)
cout<<"Este numero SI esta en el rango establecido";
else
cout<<"Este Numero NO esta en el rango establecido";
